                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center"><?= $user1['nama']; ?></h3>

                            <p class="text-muted text-center"><?= $user1['jabatan']; ?></p>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted"><?= $user1['jenis_jabatan']; ?></p>

                            <hr>
                            <strong><i class="fas fa-chalkboard-teacher mr-1"></i> Jabatan</strong>

                            <p class="text-muted"><?= $user1['jabatan']; ?></p>
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted"><?= $user1['tgl_akhir']; ?></p>
