        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md">
                                        <a href="<?= base_url('Pmi_ilegal')?>" class="btn btn-danger">selesai</a>

                                    </div>
                                    <div class="col-md" style="margin-left:450px;">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Korban</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $us['no_korban']; ?></td>
                                            <td>
                                                <a href="<?= base_url('Pmi_ilegal/hapus/') . $us['no_korban'].'/'.$us['id_pendukung']; ?>"
