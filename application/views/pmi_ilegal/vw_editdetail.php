                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" value="<?= $korban['nama'];?>" class="form-control"
                                        id="nama" placeholder="Masukkan Pelaksana">
                                    <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>

                                <div class="form-group">
                                    <label for="no_paspor">Nomor Paspor</label>
                                    <input type="text" name="no_paspor" value="<?= $korban['no_paspor'];?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_ktp" value="<?= $korban['no_ktp'];?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Daerah_asal_rekrut"
                                        value="<?= $korban['Daerah_asal_rekrut'];?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="negara_tujuan" value="<?= $korban['negara_tujuan'];?>"
